...
sealed class SerialNotation {
    ...
    data class MovePlayer(
        ...
        override fun asMove(boardState: BoardState) = PentaMove.MovePlayer(
    ...
    data class ForcedMovePlayer(
        ...
        override fun asMove(boardState: BoardState) = PentaMove.ForcedPlayerMove(
            playerPiece = boardState.figures.filterIsInstance<Piece.Player>().first { it.playerId == player && it.id == piece },
            from = PentaBoard.get(from)!!,
            to = PentaBoard.get(to)!!
        )
    ...
    data class SwapOwnPiece(
        ...
        override fun asMove(boardState: BoardState) = PentaMove.SwapOwnPiece(
            playerPiece = boardState.figures.filterIsInstance<Piece.Player>().first { it.playerId == player && it.id == piece },
    ...
    data class SwapHostilePieces(
        ...
        override fun asMove(boardState: BoardState): PentaMove = PentaMove.SwapHostilePieces(
            playerPiece = boardState.figures.filterIsInstance<Piece.Player>().first { it.playerId == player && it.id == piece },
    ...
    data class SetGrey(
        ...
        override fun asMove(boardState: BoardState) = PentaMove.SetGrey(
    ...
    data class SetBlack(
        ...
        override fun asMove(boardState: BoardState) = PentaMove.SetBlack(
